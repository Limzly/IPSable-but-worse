...
pub(crate) struct GenericContactConstraintBuilder {
    ...
    ccd_thickness: Real,
    /// IPL atlas Tier 1: portal translations (see coulomb builder).
    portal_shift1: Vector,
    portal_shift2: Vector,
}
...
impl GenericContactConstraintBuilder {
    ...
    pub fn generate(
        ...
        // IPL atlas Tier 1: mapped center of mass for imaged colliders (ZERO shifts
        // for ordinary contacts; see the coulomb builder for the rationale).
        let portal_shift1 = manifold.data.portal_shift1;
        let portal_shift2 = manifold.data.portal_shift2;

        for k in 0..manifold_points.len() {
            let manifold_point = &manifold_points[k];
            let point = manifold_point.point;
            let dp1 = point - (mprops1.world_com + portal_shift1);
            let dp2 = point - (mprops2.world_com + portal_shift2);
            ...
            let infos = CoulombContactPointInfos {
                local_p1: rb1
                    .pos
                    .position
                    .inverse_transform_point(manifold_point.point - portal_shift1),
                local_p2: rb2
                    .pos
                    .position
                    .inverse_transform_point(manifold_point.point - portal_shift2),
    ...
    pub fn update(
            ...
            .zip(tangent_parts.iter_mut())
        {
            ...
            let p1 = pose1 * info.local_p1 + self.portal_shift1 + info.tangent_vel * solved_dt;
            let p2 = pose2 * info.local_p2 + self.portal_shift2;
