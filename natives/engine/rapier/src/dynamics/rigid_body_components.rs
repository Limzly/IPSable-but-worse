...
impl RigidBodyColliders {
    ...
    pub fn attach_collider(
        ...
        co_pos.0 = co_parent.collider_pose(&rb_pos.position);
    ...
    pub(crate) fn update_positions(
        ...
        for handle in &self.0 {
            ...
            // IPL atlas: composes the portal prefix for image colliders.
            let new_pos = co.parent.as_ref().unwrap().collider_pose(parent_pos);
